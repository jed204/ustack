...
public class UTextArea extends TextArea {
	...
	public UTextArea(String fieldName)
	{
		super();
		setup(fieldName);
	}
	
	public UTextArea(String fieldName, Extent size)
	{
		super();
		setup(fieldName);
		setWidth(size);
	...
	public UTextArea(String fieldName, Extent size, Extent height)
	{
		super();
		setup(fieldName);
		setWidth(size);
	...
	public UTextArea(String fieldName, Extent size, Extent height, Font font)
	{
		super();
		setup(fieldName);
		setWidth(size);
	...
	public UTextArea(String fieldName, Extent size, ActionListener al, String cmd)
	{
		super();
		setup(fieldName);
		setWidth(size);
	...
	{
		return UEntryValidation.validateString(getFieldName(), getText(), minLength, -1);
	}
	
	/** verifies the string is at least maxLength in characters */
	public List<UEntryError> validateStringMaxLen(int maxLength)
	{
		return UEntryValidation.validateString(getFieldName(), getText(), -1, maxLength);
	}
	...
	public List<UEntryError> validateLonMin(int min)
	{
