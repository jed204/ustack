...
public class Authorization {
	...
	/**
	 * Verify authorization of current user and application, throws an exception
	 * 
	 * @param perm
	 * @throws AuthorizationException
	 */
	public static void authUserAppThrow(UStackPermissionEnum perm) throws AuthorizationException
	{
		UserAccount user = ApplicationInstance.getCurrentUser();
		String resource = ApplicationInstance.getCurrentResourceName();
		authorizeUser(user, resource, null, perm);
	}

	/**
	 * Verify authorization of current user and application, return a boolean
	 * @param requestedAction
	 * @return
	 */
	public static boolean authUserApp(UStackPermissionEnum perm)
	{
		UserAccount user = ApplicationInstance.getCurrentUser();
		String resource = ApplicationInstance.getCurrentResourceName();
		return authorizeUserBool(user, resource, perm);
	}
	
	/**
	 * Verify authorization of current user, return a boolean
	 * @param resource
	 * @param perm
	 * @return
	 */
	public static boolean authorizeCurrentUser(String resource, UStackPermissionEnum perm)
	{
		UserAccount user = ApplicationInstance.getCurrentUser();
		return authorizeUserBool(user, resource, perm);
	}
	...
	{		
		try {
			 ...
			 * Check Cache First
			 */
			if (ApplicationInstance.getCacheEnabled())
			{
